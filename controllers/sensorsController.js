    ...
    insert: async (req,res)=>{
        ...
        const patient= await User.findOne({email:req.body.email})
         Sensor.findOneAndUpdate(
            ...
            if((req.body.spo2>90) && (req.body.bpm<100)){
                res.status(200).json({
                    status:"SUCCESS",
